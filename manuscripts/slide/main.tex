...
\begin{itemize}\setlength{\itemsep}{1pt}\scriptsize
  ...
  \item $K_{\text{solve}}\le$50 CSP {\tiny\color{gray}(logic, no Docker)}; Sequential, 1 worker
  \item \tiny\color{success!50!black}\textit{CGAR thường về đích trong $\le$5 build (tỉa không gian) $\Rightarrow$ dùng \textbf{ít budget hơn} trong cùng trần}
\end{itemize}
