...
{\tiny\color{gray}$C_0=\varnothing$ (không cho trước). Mỗi lỗi Docker $=$ một \emph{counterexample} $\Rightarrow$ agent \textbf{acquire} ràng buộc (\emph{Constraint Acquisition}, CA; kiểu CEGIS), \textbf{không} solve một CSP có sẵn.}
