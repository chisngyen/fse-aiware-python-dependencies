...
\midrule
Session Memory (Level 1) & \num{1052} & 41.8\% \\
Python~2 Heuristic (no LLM) & 405 & 16.1\% \\
Other Deterministic (Levels 2--5) & 256 & 10.2\% \\
LLM Fallback (Level 6) & 806 & 32.0\% \\
\midrule
...
With \num{2519} out of \num{2890} snippets fixed, \textsc{MemRes} hits an 87.2\% overall success rate, easily beating PLLM's reported 54.7\%.
...
Of the \num{2519} successful pipelines, Python~2.7 execution environments accounted for the vast majority (75.8\%), followed by Python~3.7 (14.6\%) and Python~3.6 (5.1\%), empirically verifying that precise interpreter detection addresses the dominant failure mode on historical snippets.
