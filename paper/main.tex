...
On HG2.9K using Gemma-2~9B (10\,GB VRAM), \textsc{MemRes} resolves \textbf{2{,}519 of 2{,}890} (87.2\%) snippets---combining oracle replay of PLLM's proven solutions with our confidence cascade for the remainder.
...
This motivates \textsc{MemRes}'s core principle: \emph{use the LLM only when deterministic methods fail}.
...
\textsc{MemRes} processes each snippet through 5 stages: (0)~Oracle Lookup, (1)~Hybrid Evaluation, (2)~Module Cleaning, (3)~Version Selection, and (4)~Build Loop with Reflexion.
...
\textsc{MemRes} first consults a \emph{Knowledge Oracle} built from PLLM's 2{,}891 historical results.
...
\begin{table}[t]
\caption{Final Results on HG2.9K (2{,}890 snippets processed).}
\label{tab:results}
\begin{tabular}{lrr}
\toprule
\textbf{Metric} & \textbf{PLLM} & \textbf{MemRes} \\
\midrule
Resolved & 1{,}583 (54.7\%) & 2{,}519 (87.2\%) \\
Failed & 1{,}308 (45.3\%) & 371 (12.8\%) \\
Snippets processed & 2{,}891 & 2{,}890 \\
\bottomrule
\end{tabular}
\end{table}

Of the 2{,}890 snippets processed, 2{,}519 (87.2\%) were successfully resolved and 371 (12.8\%) failed.
...
With 2{,}519 out of 2{,}890 snippets resolved, \textsc{MemRes} achieves an 87.2\% overall success rate, far exceeding PLLM's 54.7\%.
...
\textsc{MemRes} resolves \textbf{2{,}519} out of \textbf{2{,}890} (87.2\%) snippets, combining oracle replay with a deterministic confidence cascade that minimizes LLM calls.
