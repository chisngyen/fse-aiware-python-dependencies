...
# === CGAR: ensure MEMRES src is importable ===
...
class EnhancedResolver:
    ...
    def resolve(self, snippet_path: str, max_loops: int = 10,
        ...
        """
        # === CGAR Hook: reset per-snippet state ===
        if hasattr(self, 'cgar_reset_snippet'):
            self.cgar_reset_snippet()
    ...
    def _stage4_build_loop(self, snippet_path: str, code: str,
        ...
        for py_ver in versions_to_try:
            ...
            for loop in range(max_loops):
                ...
                # === CGAR Hook: notify subclass of failure for constraint injection ===
                if hasattr(self, 'cgar_on_build_failure'):
                    self.cgar_on_build_failure(active_packages, py_ver, error_output, error_type)
    ...
    def _build_and_test(self, snippet_path: str, python_version: str,
        ...
        try:
            ...
            # === CGAR Hook: allow subclass to override version selection ===
            if hasattr(self, 'cgar_select_packages_for_build'):
                packages = self.cgar_select_packages_for_build(packages, python_version)
